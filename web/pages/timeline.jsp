					...
					<c:forEach var="axis" varStatus="status" items="${axis_list}">
						<c:choose>
							<c:when test="${axis.id==0}">
								...
								<div class="line">
                <span class="timeline-year-btn btn"
					  ...
					  data-content="<h3> ${axis.year}</h3>">
							...
							<c:otherwise>
								<div class="line">
									<div class="timeline-content-btn btn"
										 data-container="body" data-toggle="show" data-placement="right"
										 data-content="<a href='${pageContext.request.contextPath}/ArticleServlet?id=${axis.id}'>&nbsp;&nbsp;${axis.month}-${axis.day}
                      &nbsp;&nbsp;&nbsp;&nbsp;${axis.title}"></div>
								</div>
							</c:otherwise>
						</c:choose>
