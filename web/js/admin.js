 ...
 * @param article_id
 */
function delete_article(btnElem , article_id){
	btnElement = btnElem;
	var url = "/MyBlog/servlet/AdminDataServlet?op=delete_article"+"&article_id="+article_id;
	ajaxSend(url, "get", "", deleteArticleCallback, consoleFun, emptyFun());
	//remove 视图
	// var recorder = btnElement.parentNode.parentNode.parentNode;
